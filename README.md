...
Edit the buzzwords.txt file in the ProjectFiles folder and play some bingo.

![runtimeExampleImage](https://media.githubusercontent.com/media/sws-OptixSamples/BuzzwordBingo5x5/main/ProjectFiles/runtimeExampleImage.png?raw=true)
